...
bool World::init(const char *title, int xpos, int ypos, int width, int height, bool fullscreen){
	...
	if(!TextureManager::Instance()->load("C:/cn1uet/SDL/SDLFlappyBird/image/images/start.png","start", m_pRenderer)){
		return false;
	}
	num = "";
	if(!TextureManager::Instance()->load("C:/cn1uet/SDL/SDLFlappyBird/image/images/gameover.png", "gameover", m_pRenderer)){
		return false;
	}
	if(!TextureManager::Instance()->load("C:/cn1uet/SDL/SDLFlappyBird/image/images/4.png", "bg_day", m_pRenderer)){
		return false;
	}
	if(!TextureManager::Instance()->load("C:/cn1uet/SDL/SDLFlappyBird/image/images/0.png", "bird", m_pRenderer)){
		return false;
	}
	if(!TextureManager::Instance()->load("C:/cn1uet/SDL/SDLFlappyBird/image/images/pipe.png", "pipe", m_pRenderer)){
		return false;
	}
	if(!TextureManager::Instance()->load("C:/cn1uet/SDL/SDLFlappyBird/image/images/5.png", "ground", m_pRenderer)){
		return false;
	}
	int start_x = 0;
	int start_y = 0;
